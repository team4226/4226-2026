...
public class uptake2 extends SubsystemBase{
    public SparkFlex m_motor;
    public SparkClosedLoopController m_controller;
    public SparkFlexConfig m_config;


    public uptake2(){
        m_motor = new SparkFlex(Constants.MotorIDS.uptake2, MotorType.kBrushless);
        ...
        m_config.closedLoop
            ...
            .p(Constants.uptakeConst.kP)
            .i(Constants.uptakeConst.kI)
            .d(Constants.uptakeConst.kD)
        ...
        m_config.closedLoop.maxMotion
            ...
            .cruiseVelocity(Constants.uptakeConst.kMaxMotionVelocity)
            .maxAcceleration(Constants.uptakeConst.kMaxMotionAcceleration)
    ...
    public void runUptake(double speed){
        m_motor.set(speed);
    }
